...
import {
  ...
  PROFILE_COLLECTION_ID, // Added Profile Collection
...
export default function DepositPage() {
  ...
  // Fetch user account status on load
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        ...
        if (profileRes.documents.length > 0) {
          setAccountStatus(profileRes.documents[0].accountStatus ?? "active");
        }
      } catch (error) {
  ...
  const handleStartDeposit = () => {
    if (isRestricted) {
      toast.error("Account restricted. Cannot initiate deposit.");
      return;
    }
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="mb-10 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Securely deposit capital into your wallet.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            {accountStatus === "dormant" && (
              <div className="flex items-center gap-3 p-4 rounded-[1.5rem] bg-red-50 border border-red-200 text-red-800 shadow-sm dark:bg-red-900/20 dark:border-red-800/50 dark:text-red-200">
                ...
                <p className="text-sm font-medium">
                  <strong>Account Dormant:</strong> Deposits are currently
            ...
            {accountStatus === "suspended" && (
              <div className="flex items-center gap-3 p-4 rounded-[1.5rem] bg-red-50 border border-red-200 text-red-800 shadow-sm dark:bg-red-900/20 dark:border-red-800/50 dark:text-red-200">
                ...
                <p className="text-sm font-medium">
                  ...
                  suspended. You cannot make new deposits. Please contact
                  support.
                </p>
              </div>
            )}
            ...
            <div
              className={`bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-[2rem] p-8 shadow-sm relative overflow-hidden ${isRestricted ? "opacity-75" : ""}`}
            >
                ...
                {step === "form" && (
                  ...
                  >
                    <div>
                      ...
                      <div
                        className={`group relative mt-10 flex items-center justify-center border-b-2 border-gray-100 py-4 transition-all duration-300 dark:border-white/10 ${!isRestricted && "focus-within:border-brand-500"}`}
                      >
                        {/* Dollar Sign */}
                      ...
                      {PRESET_AMOUNTS.map((amt) => (
                        <button
                          ...
                          className={`
                            ...
                            ${
                              isRestricted
                                ? "border-gray-100 text-gray-400 dark:border-white/5 dark:text-white/30 cursor-not-allowed"
                    ...
                    {paymentMethod === "bitcoin" && (
                      <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-5 border border-gray-200 dark:border-white/10 text-center">
                        ...
                        <div className="flex items-center justify-center gap-2 bg-white dark:bg-black/40 p-3 rounded-xl border border-gray-200 dark:border-white/10 mb-4">
                          <code className="text-sm font-mono text-brand-600 dark:text-brand-400 break-all">
                            {bitcoinAddress}
                          </code>
                          <button
          ...
          <div className="bg-gray-900 text-white rounded-[2rem] p-8 shadow-2xl relative overflow-hidden flex flex-col justify-between h-full min-h-[400px]">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p
                    className={`text-4xl font-mono font-bold tracking-tight ${isRestricted ? "text-white/40" : ""}`}
                  >
                    $
                    {amount
                ...
                <div className="space-y-4 pt-6 border-t border-white/10">
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`${isRestricted ? "text-red-400" : "text-brand-400"} font-semibold text-sm`}
                    >
                      {isRestricted
                        ? "Blocked"
                        : step === "form"
            ...
            <div className="mt-8 pt-6 border-t border-white/10 text-xs text-white/40 leading-relaxed">
              <p>
                ...
                confirmation. Please upload a clear screenshot of your transfer
