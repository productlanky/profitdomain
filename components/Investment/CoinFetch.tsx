    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] w-full rounded-[2rem] border border-red-500/20 bg-red-500/5 backdrop-blur-md p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-xs mx-auto">
          We couldn't connect to the exchange feed. This might be due to network
          restrictions.
        </p>
        <Button
          onClick={() => {
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-black/5 dark:bg-white/5 text-xs uppercase font-semibold text-muted-foreground">
              <tr>
                ...
                <th className="px-6 py-4 text-center hidden lg:table-cell w-[180px]">
                  7d Trend
                </th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <div
                        className={`inline-flex items-center gap-1 font-bold ${isUp ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}
                      >
                        {isUp ? (
                    ...
                    <td className="px-6 py-4 text-right text-muted-foreground hidden md:table-cell">
                      $
                      {(coin.total_volume / 1000000).toLocaleString(undefined, {
