...
import AdminRankManager from "@/components/AdminComponent/RankComponent";
    ...
    try {
      ...
      const totalStockValue = stockRes.documents.reduce(
        (sum: number, tx: any) => {
          ...
          const stockTypeKey = tx.shareType?.toLowerCase?.() || "";
    ...
    <>
      <div className="px-4 md:px-10 py-10">
        <div className="max-w-7xl mx-auto">
          <div className="space-y-6">
            ...
            <div className="py-3 flex items-center justify-between">
              <Link href="/admin-Dashboard-Panel">
                <button className="hover:bg-white/0 text-base dark:text-white/70 font-semibold gap-2 hover:dark:text-white/80 text-black/70 hover:text-black/80 flex items-center">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-2xl border border-border bg-card p-4">
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Includes deposits, profit & shares
                </p>
              </div>
            ...
            {/* Rank / Account Upgrade Manager */}
            <div>
              <AdminRankManager
                docId={user} // 'user' is the profile document ID
                initialTier={profile.tier_level ?? 1}
                initialStatus={profile.account_status ?? "active"}
                initialWarning={profile.rank_warning ?? false}
                onUpdate={(updates) => {
                  // This updates the UI immediately without needing to refresh
          ...
          {/* Edit Modal (unchanged from your original logic) */}
          <Modal
            isOpen={isOpen}
            onClose={closeModal}
