        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground text-sm md:text-base max-w-xl">
              Track the most traded crypto pairs and spot opportunities before
              everyone else. Prices sourced directly from Binance & CoinGecko.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          {accountStatus === "active" && (
            <div className="flex items-center gap-2 p-3 rounded-lg bg-blue-500/5 border border-blue-500/10 text-blue-600 dark:text-blue-400 text-xs md:text-sm">
              ...
              <span>
                Click{" "}
                <strong className="font-semibold underline decoration-dotted">
                  Invest
                </strong>{" "}
                on any asset below to open the dedicated trading terminal for
                that pair.
              </span>
            </div>
          )}
          ...
          {accountStatus === "reviewing_upgrade" && (
            <div className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 border border-blue-200 text-blue-800 shadow-sm dark:bg-blue-900/20 dark:border-blue-800/50 dark:text-blue-200">
              <Loader2 className="h-5 w-5 animate-spin flex-shrink-0" />
              <p className="text-sm font-medium">
                <strong>Upgrade in Progress:</strong> Your account upgrade is
                currently under review. Trading functionality may be limited.
              </p>
            </div>
          )}

          {accountStatus === "dormant" && (
            <div className="flex items-center gap-3 p-4 rounded-xl bg-red-50 border border-red-200 text-red-800 shadow-sm dark:bg-red-900/20 dark:border-red-800/50 dark:text-red-200">
              <ShieldAlert className="h-5 w-5 flex-shrink-0" />
              <p className="text-sm font-medium">
                <strong>Account Dormant:</strong> Your trading features are
          ...
          {accountStatus === "suspended" && (
            <div className="flex items-center gap-3 p-4 rounded-xl bg-red-50 border border-red-200 text-red-800 shadow-sm dark:bg-red-900/20 dark:border-red-800/50 dark:text-red-200">
              ...
              <p className="text-sm font-medium">
                <strong>Account Suspended:</strong> Trading is disabled on your
